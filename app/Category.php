...
class Category extends Model {
    ...
    public $properties = array('id','name','parent_id','created_at','updated_at');
    ...
    public function getDataForPaginationAjax($dataRequest,$config){
        ...
        if(isset($dataRequest['sort'])) {
            ...
            $sortColum = ['id','name','parent_id','created_at','updated_at'];
        ...
        $query = $this->where('id', 'LIKE', '%'.$dataRequest['searchPhrase'].'%')
            ...
            ->orWhere('parent_id', 'LIKE', '%'.$dataRequest['searchPhrase'].'%')
