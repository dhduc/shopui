...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal form-row-seperated" action="{{ URL::action('Admin\ProducerController@index') }}"
                  method="Post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-notebook"></i><?php echo Lang::get('messages.create_producer'); ?>
                        </div>
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="producer" value="{{ old('producer', '')}}" id="producer" placeholder="<?php echo Lang::get('messages.producer_producer'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="portlet-body">
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="information" value="{{ old('information', '')}}" id="information" placeholder="<?php echo Lang::get('messages.producer_information'); ?>">
                            </div>
                        </div>
                    </div>
