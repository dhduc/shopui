...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal form-row-seperated" action="{{ URL::action('Admin\PagesController@update', $result->id) }}" method="Post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="_method" value="PUT">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-share"></i><?php echo Lang::get('messages.edit_pages'); ?>
                        </div>
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title" value="{{ old('title', $result['title'])}}" id="title" placeholder="<?php echo Lang::get('messages.pages_title'); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="wysihtml5 form-control" name="content">{{ $result['content'] }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            <label for=created_at" class="col-sm-2 control-label"><?php echo Lang::get('messages.pages_created_at'); ?></label>
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control" name="created_at" value="{{ old('created_at', $result['created_at'])}}" id="created_at" placeholder="<?php echo Lang::get('messages.pages_created_at'); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            <label for=updated_at" class="col-sm-2 control-label"><?php echo Lang::get('messages.pages_updated_at'); ?></label>
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control" name="updated_at" value="{{ old('updated_at', $result['updated_at'])}}" id="updated_at" placeholder="<?php echo Lang::get('messages.pages_updated_at'); ?>">
                            </div>
                        </div>
                    </div>
