        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-shopping-cart"></i><?php echo Lang::get('messages.list_images'); ?> of Slider
                    </div>

                </div>
                <div class="portlet-body" style="">
                    <form class="form-horizontal form-row-seperated" action="{{ URL::action('Admin\SliderController@index') }}"
